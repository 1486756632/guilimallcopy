package com.bj.order.web;

import com.bj.exceptionCode.NotStockException;
import com.bj.order.service.OrderService;
import com.bj.order.vo.OrderConfirmVo;
import com.bj.order.vo.OrderSubmitVo;
import com.bj.order.vo.SubmitOrderResponseVo;
	...
	public String submitOrder(OrderSubmitVo submitVo, Model model, RedirectAttributes redirectAttributes){
		...
		try {
			...
			if(responseVo.getCode() == 0){
				...
				return "redirect:http://order.storetemplate.com/toTrade";
			}
		} catch (Exception e) {
