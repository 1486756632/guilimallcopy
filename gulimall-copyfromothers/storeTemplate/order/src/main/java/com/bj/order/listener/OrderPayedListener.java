package com.bj.order.listener;

import com.alipay.api.AlipayApiException;
import com.alipay.api.internal.util.AlipaySignature;
import com.bj.order.config.AlipayTemplate;
import com.bj.order.service.OrderService;
import com.bj.order.vo.PayAsyncVo;
...
public class OrderPayedListener {
	...
	public String handleAliPayed(PayAsyncVo vo, HttpServletRequest request) throws UnsupportedEncodingException, AlipayApiException, AlipayApiException {
		log.info("\n收到支付宝最后的通知数据：\n" + vo);
