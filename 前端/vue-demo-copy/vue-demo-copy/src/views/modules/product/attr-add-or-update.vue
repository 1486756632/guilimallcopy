        ...
        if (this.dataForm.attrId) {
          ...
          this.$http({
            ...
            if (data && data.code === 0) {
              ...
              //  let newFilArr = filArr.filter( (item,i) =>{
              //   console.log("循环==i==",i);
              //   return item >= 3
              //   } )
              ...
              // var _this = this
              // this.dataForm.attrGroupId=[]
              // data.attr.filter( (item,i) =>{
              // // console.log("循环==i==",i);
              // this.dataForm.attrGroupDesc.push(item.descript)
              // this.dataForm.attrGroupId.push(item.attrGroupId)
              // } )
              // this.dataForm.attrName = data.attr.attrName;
              // this.dataForm.searchType = data.attr.searchType;
              // this.dataForm.valueType = data.attr.valueType;
              ...
              // this.dataForm.showDesc = data.attr.showDesc;
              // //attrGroupId
              // console.log("data.attr.attrGroupDesc 11111   "+this.dataForm.attrGroupDesc)
              // //catelogPath
              // this.catelogPath = data.attr.catelogPath;
              // this.$nextTick(() => {
                this.dataForm.attrGroupId = data.attr;
                console.log("data.attr.attrGroupId    "+this.dataForm.attrGroupId)
              // });
            }
          });
        }
