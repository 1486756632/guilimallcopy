package com.storeTemplate.cart.controller;
...
public class CartController {
    private final String PATH = "redirect:http://cart.storetemplate.com/cart.html";
    @Autowired
    ...
    public String addToCart(@RequestParam("skuId") Long skuId, @RequestParam("num") Integer num, RedirectAttributes redirectAttributes) throws ExecutionException, InterruptedException {
        ...
        // 重定向到成功页面
        return "redirect:http://cart.storetemplate.com/addToCartSuccess.html";
    }
