package com.storeTemplate.cart.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.bj.utils.R;
import com.storeTemplate.cart.feign.ProductFeignService;
import com.storeTemplate.cart.intercepter.CartInterCepter;
import com.storeTemplate.cart.service.CartService;
import com.storeTemplate.cart.vo.Cart;
import com.storeTemplate.cart.vo.CartItem;
import com.storeTemplate.cart.vo.SkuInfoVo;
	...
	public CartItem addToCart(Long skuId, Integer num) throws ExecutionException, InterruptedException {
		...
		if(StringUtils.isEmpty(res)){
			...
			CompletableFuture<Void> getSkuInfo = CompletableFuture.runAsync(() -> {
				...
				Object data = skuInfo.get("skuInfo");
				String s = JSON.toJSONString(data);
				SkuInfoVo sku = JSONObject.parseObject(s, SkuInfoVo.class);
				// 2. 添加新商品到购物车
